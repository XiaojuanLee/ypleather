...
export default function Navbar() {
    return (
        <nav className="fixed top-0 left-0 w-full bg-white shadow-lg z-50 text-white p-0 border-b border-gray-200">
            <div>
                <p className='bg-[#42563b] text-[#f0cba1] text-white text-center p-2 text-xs font-bold'>SHARE YOUR PROJECT AND TAG US TO RECEIVE A 10% OFF COUPON FOR YOUR NEXT PURCHASE!</p>
                {/* #c52a38 */}
            </div>
